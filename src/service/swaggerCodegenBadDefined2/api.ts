...
export const EsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        delIndexUsingDELETE(body?: Array<string>, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<ReplyVOint> {
            const localVarFetchArgs = EsApiFetchParamCreator(configuration).delIndexUsingDELETE(body, options);
...
export const EsApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        ...
        delIndexUsingDELETE(body?: Array<string>, options?: any) {
            return EsApiFp(configuration).delIndexUsingDELETE(body, options)(fetch, basePath);
        },
    };
};
...
export class EsApi extends BaseAPI {
    ...
    public delIndexUsingDELETE(body?: Array<string>, options?: any) {
        return EsApiFp(this.configuration).delIndexUsingDELETE(body, options)(this.fetch, this.basePath);
    }
